...
import { OptionsListProps, GroupShape, OptionShape, GroupDividerItem } from '../../typings';
        ...
        const renderGroup = useCallback(
            (group: GroupShape) => (
                <Optgroup
                    ...
                    optionGroupDividerClassName={optionGroupDividerClassName}
            ...
            [optionGroupClassName, optionGroupDividerClassName, counter, renderOption, size],
        );
